...
class DataGenerator(object):
    ...
    def make_data_tensor(self, train=True):
        ...
        filename_queue = tf.compat.v1.train.string_input_producer(tf.convert_to_tensor(value=all_filenames), shuffle=False)
        ...
        images = tf.compat.v1.train.batch(
                [image],
        ...
        for i in range(self.batch_size):
            ...
            if FLAGS.datasource == 'omniglot':
                ...
                rotations = tf.random.categorical(logits=tf.math.log([[1., 1.,1.,1.]]), num_samples=self.num_classes)
            label_batch = tf.convert_to_tensor(value=labels)
